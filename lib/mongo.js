...
exports.Following = mongolass.model('Following', {
  following: { type: Mongolass.Types.ObjectId },
  userId: { type: Mongolass.Types.ObjectId }
});
exports.Lessoncmt.index({ following: 1, _id: 1 }).exec();// 通过用户 id 获取关注列表，按创建时间升序
exports.Lessoncmt.index({ userId: 1, following: 1 }).exec();// 通过用户 id 和被关注人 id 删除一个关注
